  ...
  Future<void> fetchBooksFromAPI() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (refreshResponse.statusCode == 200) {
        ...
        print("access after apply refresh $newTokens");
              ...
              builder: (context, fileSnapshot) {
                ...
                if (isDownloading) {
                  trailingWidget = SizedBox(
                    ...
                    height: 24,
                    child: (progress == null)
                        ? CircularProgressIndicator(strokeWidth: 3, color: Color(0xFF1F2F98))
                        : CircularProgressIndicator(value: progress, strokeWidth: 3, color: Color(0xFF1F2F98)),
                  );
                } else if (fileExists) {
